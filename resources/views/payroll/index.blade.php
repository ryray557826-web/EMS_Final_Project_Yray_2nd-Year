        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center gap-4">
                    ...
                    @else
                        <span class="bg-[#ff2d75]/10 text-[#ff2d75] text-[9px] font-black px-4 py-2 rounded-full uppercase tracking-widest border border-[#ff2d75]/20">
                            Branch Managed Desk
                        </span>
                    @endif
                </div>
            ...
            <div class="bg-[#161616] p-8 rounded-3xl border border-[#262626]">
                <div class="flex items-center justify-between mb-6">
                    <h3 class="text-sm font-black text-[#d97706] uppercase tracking-widest">
                        ⚠️ Branch Modification Requests Desk
                    </h3>
                ...
                @if($pendingRequests->isEmpty())
                    <p class="text-gray-500 text-xs uppercase tracking-widest">No incoming adjustment requests for your branch scope.</p>
                @else
